...
// NVA reģistrēti bezdarbnieki un darba meklētāji — 170826_BD.xlsx
const unemployedSchedules = [
  // --- Angļu valoda (bez priekšzināšanām) [8 GRUPAS] ---
  {
    ...
    endDate: '14.10.2026',
    time: '18:20–21:10',
    intensity: 'Darba dienās (5x nedēļā)',
  ...
  // --- Angļu valoda (ar priekšzināšanām) (Elementary) [9 GRUPAS] ---
  {
    id: 9,
  ...
  // --- Angļu valoda (ar priekšzināšanām) (Higher Intermediate) [1 GRUPA] ---
  {
    id: 32,
  ...
  // --- Biznesa angļu valoda (Higher Intermediate) [1 GRUPA] ---
  {
    id: 33,
    program:
...
export default function Calendar() {
  ...
  const renderTable = (items: typeof unemployedSchedules) => (
  ...
  const renderMobileList = (items: typeof unemployedSchedules) => (
        ...
        <div className="max-w-7xl mx-auto space-y-16">
          <div>
            <h3 className="text-2xl md:text-3xl font-bold text-[#101e33] mb-6">
              Angļu valodas kursi NVA (Nodarbinātības valsts aģentūrā)
          ...
          <div className="mt-4 bg-[#101e33] p-8 rounded-2xl text-white shadow-xl relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p className="text-gray-300 leading-relaxed max-w-none w-full">
                ...
                Nodarbinātības valsts aģentūru (NVA) projekta
                &quot;ESF Plus projekts “Atbalsts pieaugušo izglītībai” Nr.
                4.3.3.1/1/26/I/001&quot; ietvaros. Ja Jums ir derīgs
                apmācību kupons, apmācību izmaksas tiek segtas pilnā apmērā.
                Sazinieties ar mums, lai precizētu reģistrācijas procesu,
                jautājumus par apmācību norisi u.tml.
              </p>
            </div>
