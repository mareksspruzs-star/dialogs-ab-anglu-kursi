...
// NVA reģistrēti bezdarbnieki un darba meklētāji — 080826_BD.xlsx
          ...
          <div className="mt-4 bg-[#101e33] p-8 rounded-2xl text-white shadow-xl relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p className="text-gray-300 leading-relaxed max-w-none w-full">
                ...
                Nodarbinātības valsts aģentūru (NVA) projekta  &quot;ESF Plus projekts “Atbalsts pieaugušo izglītībai” Nr. 4.3.3.1/1/26/I/001&quot; ietvaros. Ja Jums ir derīgs
